   ...
   <div class="overlay"></div>
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
     <ul class="nav sidebar-nav">
       ...
       <li><a href="#about"><i class="fas fa-user-graduate"></i> Estudiantes</a></li>
       <li><a href="#events"><i class="fas fa-chalkboard-teacher"></i> Docentes</a></li>
       <li><a href="#team"><i class="fas fa-restroom"></i> Acudientes</a></li>
       <li><a href="#team"><i class="fas fa-file-signature"></i> Faltas</a></li>
       <li class="dropdown">
     ...
     <ul class="dropdown-menu animated fadeInLeft" role="menu">
      ...
      <li><a href="#pictures"><i class="fas fa-id-card"></i> Tipo de Documento</a></li>
      <li><a href="#videos"><i class="fas fa-street-view"></i> Parentescos</a></li>
      <li><a href="#books"><i class="fas fa-calendar-alt"></i> Período</a></li>
      <li><a href="#awards"><i class="fas fa-file-excel"></i> Tipos de Faltas</a></li>
      </ul>
      </li>
      </ul>
  </nav>
                ...
                <div class="row">
					...
					<div class="card-header">
						<ul class="nav nav-tabs card-header-tabs">
							<li class="nav-item">
								<a class="nav-link active" href="#">Nivel Escolar</a>
							</li>
						</ul>
					</div>
					<div class="card-body">
