   ...
   <div class="overlay"></div>
    <nav class="navbar navbar-inverse fixed-top" id="sidebar-wrapper" role="navigation">
     ...
     <ul class="dropdown-menu animated fadeInLeft" role="menu">
      ...
      <li><a href="indexGrados.php"><i class="fas fa-file-invoice"></i> Grados</a></li>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container">
                <div class="row">
					...
					<div class="card-header">
						<ul class="nav nav-tabs card-header-tabs">
							<li class="nav-item">
								<a class="nav-link active" href="#"><i class="fas fa-university"></i> Grados</a>
							</li>
						</ul>
					</div>
					<div class="card-body">
               ...
               <span class="btn btn-success" data-toggle="modal" data-target="" style="float:right;">
                Grupos <i class="fas fa-arrow-circle-right"></i>
                </span>               
                  </div>
                </div> 
            </div>
...
<footer>
  Plataforma GT  | Prototipo Software Comportamental | 2019
	...
	<?php require_once "modalInsertGrados.php" ?>
	<?php require_once "modalUpdateGrados.php" ?>

	<script src="librerias/bootstrap4/jquery-3.4.1.min.js"></script>
	<script src="librerias/bootstrap4/popper.min.js"></script>
	<script src="librerias/bootstrap4/bootstrap.min.js"></script>
	<script src="librerias/sweetalert.min.js"></script>
	<script src="js/crudGrados.js"></script>
