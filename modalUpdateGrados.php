    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="frminsertu" onsubmit="return actualizarDatos()" method="post">
            ...
            <label>Grado</label>
              <input type="text" id="gradou" name="gradou" class="form-control form-control-sm" required="">
              <label>Descripción</label>
              <input type="text" id="descripcionu" name="descripcionu" class="form-control form-control-sm" required="">
              <label>Nivel Escolar</label>
              <select type="text" id="nivelescoalru" name="nivelescolaru" class="form-control form-control-sm" required="">
